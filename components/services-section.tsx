      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-4xl md:text-[52px] md:leading-[60px] font-bold mb-4 dark:text-white">
              My broad{" "}
              <motion.span
                whileHover={{ scale: 1.05, rotate: -2 }}
                className="bg-[#FF4A60] text-white px-4 py-1 inline-block cursor-default shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
                set of services
              </motion.span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              <div
                ...
                } bg-white dark:bg-[#1A1A1A] border-[3px] border-black dark:border-white rounded-[32px] overflow-hidden hover:translate-y-[-4px] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] transition-all duration-300 flex flex-col group`}>
                ...
                <div className="p-8 pt-4 flex-1 flex flex-col justify-center">
                  <h3 className="text-[28px] leading-[40px] font-bold mb-3 text-[#0B0B0B] dark:text-white">
                    {service.title}
                  </h3>
                  <p className="text-[18px] leading-[30px] font-medium text-[#393939] dark:text-gray-400">
                    {service.description}
                  </p>
                </div>
              </div>
